...
import { ArrowRight, Star, GraduationCap, Code, Laptop, Database } from "lucide-react";
import { 
  Carousel,
  CarouselContent,
  CarouselItem,
...
const courses = [
  {
    ...
    description: "Maîtrisez les stratégies marketing digitales et développez votre expertise dans le secteur tech."
  },
  {
    icon: <Laptop className="text-purple" />,
    title: "Automation & No-Code",
    description: "Apprenez à automatiser des processus et créer des applications sans code pour optimiser votre productivité."
  },
  {
    icon: <Database className="text-purple" />,
    title: "Webmaster & Gestion de Site Web",
    description: "Développez les compétences nécessaires pour gérer et maintenir des sites web professionnels."
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h5 className="text-purple mb-2 flex items-center justify-center gap-2">
            ...
            <span className="text-lg font-semibold tracking-wider uppercase">Nos Formations</span>
            <span className="w-12 h-[3px] bg-purple animate-pulse"></span>
          </h5>
          <h2 className="section-title">🚀 APPRENEZ. CONSTRUISEZ. RÉINVENTEZ L'AVENIR DE LA TECH !</h2>
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
            Des formations accessibles et inclusives pour la jeunesse africaine, avec une pédagogie innovante à l'ère de l'IA et de la Tech.
          </p>
        </div>
        ...
        <div className="mt-24">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 mt-4 max-w-2xl mx-auto">
              Découvrez les expériences de nos étudiants qui ont transformé leur carrière grâce à BinarySec Academy.
            </p>
          </div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400">{review.program}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
